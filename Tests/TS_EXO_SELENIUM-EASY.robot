...
Test01 Selenium Menu Input Forms - Simple Form Demo - Two Input Fields
    ...
    Input Text    id=sum2    7
    Click Element    xpath=//button[@onclick="return total()"]

# Vérifier que le résultat est correct (12 dans ce cas)
    Wait Until Element Contains    id=displayvalue    12
...
Test02 Selenium Menu Input Forms - Checkbox Demo - Single Checkbox Demo
    ...
    Select Checkbox    id=isAgeSelected   # Coche la case
...
Test03 Selenium Menu Input Forms - Checkbox Demo - Multiple Checkbox Demo
    ...
    SeleniumLibrary.Click Element    xpath=//ul[@id='treemenu']//a[text()='Input Forms']
    SeleniumLibrary.Click Element    xpath=//ul[@id='treemenu']//a[text()='Checkbox Demo']
    locator_check_all    xpath=//input[@id='check1'][@value='Check All']
    locator_uncheck_all    xpath=//input[@id='check1'][@value='Uncheck All']
    Select Checkbox    value=Option 1
    Select Checkbox    value=Option 2
    Select Checkbox    value=Option 3
    Select Checkbox    value=Option 4
    Wait Until Element Contains    ${locator_check_all}    'Uncheck All'
    # CODE A IMPLEMENTER ICI
